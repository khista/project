...
let message =text1.concat(text2);
console.log(message);
...
let textt = 'WORLD';
let conmbain = textf.concat(' ',texts,' ',textt);
console.log(conmbain);
//exe_42
...
let messageOne="Ready Player One is a 2011 science fiction novel, and the debut novel of American author Ernest Cline."+ 
                ...
                +"\n(a division of Random House)]. The book was published on August 16, 2011. An audiobook was released the same day;"
                +"\nit was narrated by Wil Wheaton, who was mentioned briefly in one of the chapters.Ch. 20 In 2012,"
                +"\nthe book received an Alex Award from the Young Adult Library Services Association division of the"
                +"\nAmerican Library Association and won the 2012 Prometheus Award.\n\n";
...
let toUpperCase1 = messageOne.toUpperCase();
let toLowerCase1 = messageOne.toLowerCase();

console.log(toUpperCase1);
console.log(toLowerCase1);
console.log("Concat both pharagraps.......................")
console.log(toUpperCase1.concat(toLowerCase1));
